    ...
    class Usuarios extends Controller{
        ...
        public static function adicionar(){
            ...
            if(FormHelper::getIsValid() === true){
                ...
                if(!isset($data['form_data']['usuario_apelido']) && !isset($data['form_data']['usuario_senha'])){
                    $data['form_data']['usuario_apelido'] (isset($data['form_data']['usuario_apelido'])) ? $data['form_data']['usuario_apelido'] : '';
                    $data['form_data']['usuario_senha'] (isset($data['form_data']['usuario_senha'])) ? $data['form_data']['usuario_senha'] : '';
                    $data['form_data']['usuario_csenha'] = '';
                    $data['form_data'] = $data['form_data']['usuario_senha'] + $data['form_data'];
                    $data['form_data'] = $data['form_data']['usuario_apelido'] + $data['form_data'];
                }
